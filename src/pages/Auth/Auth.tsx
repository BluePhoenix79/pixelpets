    ...
    <div className={styles.authPage}>
      <div className={styles.splitScreen}>
        ...
        <div className={styles.leftPanel}>
          ...
          <div
            className={`${styles.authTabs} ${activeTab === "signup" ? styles.switched : ""}`}
          >
            <div
        ...
        <div className={styles.rightPanel}>
          <div className={styles.heroContent}>
            {activeTab === "login" ? (
              <>
                <h2 key="login-title" className={styles.fadeText}>
                  Welcome Back!
                </h2>
                <p key="login-desc" className={styles.fadeText}>
                  Adopt, feed, and play with your own digital pets.
                </p>
              ...
              <>
                <h2 key="signup-title" className={styles.fadeText}>
                  Join the Adventure!
                </h2>
                <p key="signup-desc" className={styles.fadeText}>
                  Start your journey and collect unique pixel pets today.
                </p>
                <div className={styles.heroDecor}>
                  <div className={styles.decorCircle}></div>
                  <img
